...
const TeacherAttendance = () => {
      ...
      if (selectedSubject && date && lecture && !dataFetched) {
        try {
          const response = await axios.get(
            `http://student-teacher-portal-server.onrender.com/api/teachers/attendance/get?subjectCode=${selectedSubject}&date=${date}&lecture=${lecture}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleAttendanceSubmit = async () => {
    ...
    const url = isUpdating
      ? 'http://student-teacher-portal-server.onrender.com/api/teachers/attendance/update'
      : 'http://student-teacher-portal-server.onrender.com/api/teachers/attendance/upload';
