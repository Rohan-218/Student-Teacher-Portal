...
const TeacherProfile = () => {
  ...
  const fetchTeacherProfile = async () => {
    try {
      ...
      const response = await axios.get(`http://student-teacher-portal-server.onrender.com/api/admin/teachers/profile/${userId}`, {
        headers: {
  ...
  const handleSave = async () => {
    try {
      const token = localStorage.getItem('token');  // Get token from local storage
      const response = await axios.put('http://student-teacher-portal-server.onrender.com/api/admin/teachers/edit', {
