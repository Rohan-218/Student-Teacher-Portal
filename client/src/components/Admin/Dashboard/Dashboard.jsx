   ...
   useEffect(() => {
    ...
    const fetchBranchStudentCounts = async () => {
      try {
        ...
        const res = await fetch('http://192.168.1.17:3000/api/admin/branches/student-count', {
          method: 'GET',
          headers: {
