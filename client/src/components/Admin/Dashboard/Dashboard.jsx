   ...
   useEffect(() => {
    ...
    const fetchBranchStudentCounts = async () => {
      try {
        ...
        const res = await fetch('http://192.168.29.80:3000/api/admin/branches/student-count', {
          method: 'GET',
          headers: {
