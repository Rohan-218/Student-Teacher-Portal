...
const StudentProfile = () => {
  ...
  const fetchStudentProfile = async () => {
    try {
      ...
      const response = await axios.get(`http://student-teacher-portal-server.onrender.com/api/admin/students/profile/${userId}`, {
        headers: {
  ...
  const handleSave = async () => {
    try {
      const token = localStorage.getItem('token'); // Get token from local storage
      const response = await axios.put('http://student-teacher-portal-server.onrender.com/api/admin/students/edit', {
        user_id: userId,
